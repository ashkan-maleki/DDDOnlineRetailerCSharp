...
public class IntegrationDomainEventHandler(IEmailService emailService, IUnitOfWork uow, ILogger<IntegrationDomainEventHandler> logger) : IDomainEventHandler
{
